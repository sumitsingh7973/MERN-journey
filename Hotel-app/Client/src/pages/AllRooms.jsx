...
const CheckBox = ({ label, selected = false, oncChange = () => { } }) => {
    return (
...
const RadioButton = ({ label, selected = false, oncChange = () => { } }) => {
    return (
        <label className="flex gap-3 items-center cursor-pointer mt-2 text-sm">
...
const AllRooms = () => {
    ...
    return (
        <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
                        ...
                        <div className="md:w-1/2 flex flex-col gap-2">
                            ...
                            <div className="flex flex-wrap items-center mt-3 mb-6 gap-4 ">
                                {room.amenities.map((item, index) => (
                                    <div key={index} className="flex items-center gap-2 px-3 py-2 rounded-lg bg-[#F5F5FF] cursor-pointer">
                                        <img src={facilityIcons[item]} alt="facility-icons" className="w-5 h-5" />
            ...
            {/* filters */}
            <div className="bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 lg:mt-16 p-2">
                ...
                <div className={`${openFilters ? 'h-auto' : 'h-0 lg:h-auto'} overflow-hidden transition-all duration-700`}>
                    ...
                    <div className="px-5 pt-5 pb-56">
                        <p className="font-medium text-gray-800 pb-2"></p>Sort
