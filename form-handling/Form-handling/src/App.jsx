      ...
      <div className=' lg:w-1/2  p-10 lg:border-l-2 border-white '>
        ...
        <div className='flex flex-wrap items-start justify-start gap-5 h-full mt-5 overflow-auto text-white'>
          {task.map(function (elem, idx) {
            ...
            return <div
              key={idx}
              className="relative flex flex-col justify-between h-60 w-40 pt-9 pb-4 px-4 bg-cover rounded-xl text-black bg-[url('https://static.vecteezy.com/system/resources/previews/037/152/677/non_2x/sticky-note-paper-background-free-png.png')]"
            >
              <div>
                <h3 className="text-xl font-semibold leading-tight">
                  {elem.title}
                </h3>
                <p className="mt-2 text-sm font-medium leading-tight text-gray-800">
                  {elem.details}
                </p>
              </div>
