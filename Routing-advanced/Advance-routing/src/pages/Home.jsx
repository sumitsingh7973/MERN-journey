        ...
        <>
            <div className='border-t border-white flex justify-between'>
                <div className='min-h-150 m-5 max-w-xs'>
                    <h2 className='font-bold font-serif pt-5 text-4xl transition duration-300 hover:scale-105 hover:text-gray-700' >Travel the way you want...</h2>
                ...
                <div className="bg-cover bg-black/50 ">
                        <h1 className='ml-50 text-gray-700 transition duration-300 hover:scale-105 hover:text-white
