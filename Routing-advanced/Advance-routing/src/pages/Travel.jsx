      ...
      <div className='border-t border-white flex justify-between'>
        ...
        <div className="bg-cover bg-black/50 w-full m-2 rounded-4xl flex overflow-x-scroll gap-6 no-scrollbar p-5">
          ...
          <div className="relative min-w-50 h-60 rounded-3xl overflow-hidden transition duration-300 hover:scale-105">
            <img
              className="h-full w-full object-cover rounded-3xl transition duration-300 hover:scale-105"
              src="https://images.unsplash.com/photo-1454496522488-7a8e488e8606"
              alt=""
            />
            <button className="absolute bottom-4 left-4 bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-xl cursor-pointer transition duration-500 hover:scale-110">
              Explore
            </button>
          </div>
